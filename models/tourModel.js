...
//Creating a schema and validating using schema type options
...
//Setting index on price field
// tourSchema.index({ price: 1 });
tourSchema.index({ price: 1, ratingsAverage: -1 });
tourSchema.index({ slug: 1 });
tourSchema.index({ startLocation: '2dsphere' });

//Populating the tour document with user data
...
//Embedding the guides in the tour Document
...
//Query middleware and Using regex for it to work on find , findOne etc
