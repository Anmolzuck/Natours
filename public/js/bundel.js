...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5tb2x6YWtpZSIsImEiOiJja2Z2NGIzcG4weGF0MnF0OHlnNTVpd3NxIn0.JfCbGKfTygNavCtp_9nJ0A';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'You are account is created successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your ".concat(type.toUpperCase(), " has been updated successfully!"));
            }
...
var stripe = Stripe('pk_test_51HbmbILAv6n3UMFbNSMzaLsqeF4oNe04NIA5vkB0CAA62jhhkPjjAkgHeYMbn3Atx5suBYmVPu20opMjrXraMhBU00q1SC8NAT');
...
var signupForm = document.querySelector('.from--signup');
